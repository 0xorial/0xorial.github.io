(function() {
  ...
  exports.Shape = (function(superClass) {
  ...
  exports.Cross = (function(superClass) {
  ...
  exports.Rectangle = (function(superClass) {
    extend(Rectangle, superClass);

    function Rectangle(width, height, fill1) {
      this.width = width;
      this.height = height;
      this.fill = fill1;
  ...
  exports.MyStage = (function() {
    ...
    MyStage.prototype._calculateRotation = function(centerStage, mouseStage) {
      var _dragStartPosition, angleDiff, currentVector, startVector;
    ...
    MyStage.prototype._pickShape = function(x, y, onlyMovable) {
      var child, i, j, point, ref;
      if (onlyMovable == null) {
        onlyMovable = true;
      }
      for (i = j = ref = this._stage.children.length - 1; j >= 0; i = j += -1) {
